...
class PriorityTest < Test::Unit::TestCase
  ...
  def test_successful_refund_purchase_response
    ...
    @amount_refund = @response_string_obj['amount']
    ...
    @response_string_obj['tender_type'] = 'Card'
    ...
    response = stub_comms do
      ...
      assert_equal json['amount'], -14.14
  ...
  def test_successful_refund
    @response_string_obj = @response_purchase.transform_keys(&:to_s)
    @amount_refund = @response_string_obj['amount'].to_f
